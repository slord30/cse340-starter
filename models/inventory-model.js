...
//   return await pool.query("SELECT * FROM public.inventory ORDER BY inv_make, inv_model")
// }

/* ***************************
 *  Get all inventory details by inventory id
 * ************************** */
...
/* ***************************
 *  Assignment 4
 *  Insert new classification into classification_name column
 * ************************** */
...
async function addInventory(
  ...
  try {
    ...
    const data = await pool.query(insertData, [
      inv_make,
      inv_model,
      inv_description,
      inv_image,
